...
INC_DIR		+= $(PRO_DIR)/inc
SRC_DIR 	+= $(PRO_DIR)/src
LINKER_FILE	:= $(PRO_DIR)/linker/STM32F401CCUx_V4.ld
...
.PHONY: flash
flash:
	$(PRO_DIR)/ST-LINK_Utility/ST-LINK_CLI.exe -p $(OUTPUT_PATH)/$(PROJ_NAME).hex 0x20000008
	$(PRO_DIR)/ST-LINK_Utility/ST-LINK_CLI.exe -rst	
	
.PHONY: report
report:
	$(PRO_DIR)/ST-LINK_Utility/ST-LINK_CLI.exe -r32 0x20000004 0x04 | grep -i 00000000 > $(OUTPUT_PATH)/result.log; \
